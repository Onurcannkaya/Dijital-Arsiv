...
type View = "dashboard" | "inbox" | "review" | "archive" | "users";
...
const viewStatuses: Record<View, string[]> = {
  ...
  review: ["review", "ready"],
  archive: ["archived"],
  // Kullanıcı yönetimi belge listesi kullanmaz.
  users: [],
};
